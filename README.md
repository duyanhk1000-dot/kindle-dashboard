...
├── vnstock_crawler.py       # Multi-Provider Market Crawler (Simplize, giavang.org)
...
An automated **E-ink Smart Dashboard** built specifically for the **Kindle Touch (4th Generation - Model D01200)** and compatible 600x800 16-level grayscale E-ink displays.
